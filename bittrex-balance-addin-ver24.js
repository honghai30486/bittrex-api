...
s.src = "https://rawgit.com/honghai30486/bittrex-api/master/bittrex-api-ver2.js?ver="+(new Date()).getTime();
$("head").append(s);

s = document.createElement("script");
s.type = "text/javascript";
s.src = "https://rawgit.com/honghai30486/bittrex-api/master/notify.min.js";
$("head").append(s);

var buttonLoad = document.createElement("button");
buttonLoad.innerHTML = "(.)(.)";
buttonLoad.className = "btn btn-default btn-toolbar elem-demo";
...
function sellAll(){
	...
	$.notify("Please wait for calculate profit","info");
		...
		getmarketsummaries(function(marketsummaries){
			getorderhistory("",function(orderhistories){
				...
				$("#balanceTable tbody").find("tr").each(function(){
					...
					profit += (priceArray['BTC-'+marketName] - orderArray['BTC-'+marketName])*quantityArray[marketName];
